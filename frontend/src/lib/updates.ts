 ...
 *
 * Turning this back on needs three things together: releases on this
 * project's repository, a signing key of its own in tauri.conf.json, and that
 * repository's latest.json as the updater endpoint.
 */
