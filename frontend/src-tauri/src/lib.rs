...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audio::recording_protocol::meeting_playback_file,
            ...
            database::repositories::transcript_edit::api_remove_transcript_line,
            ...
            audio::retranscription::retranscription_status_command,
